...
public class PathFinding : MonoBehaviour
{
    ...
    void FindPath(Vector3 startPos, Vector3 targetPos) {  //IEnumerator
        ...
        //{
            ...
            while (openSet.Count > 0)
            {
                ...
                if (currentNode == targetNode)
                {
                    ...
                    RetracePath(startNode, currentNode); //Quitar
                    //pathSuccess = true;
                    break;
                }
    ...
    void RetracePath(Node startNode, Node endNode) // Vector3[]
    {
